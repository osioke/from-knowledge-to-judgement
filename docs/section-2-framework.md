...
![The HOS Three-Layer Architecture — a stacked diagram showing Instructional Deconstruction as the foundation, Thinking Frameworks as the operating layer, and the Execution Loop as the output layer](images/fig2-hos-architecture.png)

<p class="figure-caption">Figure 2. The Human Operating System — Three-Layer Architecture. Each layer builds on the one below it, and feedback flows upward as execution generates new knowledge that refines the layers beneath.</p>
